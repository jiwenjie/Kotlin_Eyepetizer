...
import com.example.root.kotlin_eyepetizer.ui.fragment.DiscoveryFragment
import com.example.root.kotlin_eyepetizer.ui.fragment.HotFragment
import com.example.root.kotlin_eyepetizer.ui.fragment.IndexFragment
import com.example.root.kotlin_eyepetizer.ui.fragment.MineFragment
 ...
 */
class MainActivity : BaseAppMvpActivity() {
   ...
   override fun onKeyDown(keyCode: Int, event: KeyEvent?): Boolean {
      if (keyCode == KeyEvent.KEYCODE_BACK) {
         if (System.currentTimeMillis().minus(mExitTime) <= 2000) {
            ...
            showToast(applicationContext, "再按一次退出程序")
         }
         return true
      }
