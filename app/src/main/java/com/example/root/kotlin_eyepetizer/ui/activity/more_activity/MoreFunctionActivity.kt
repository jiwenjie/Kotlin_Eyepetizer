package com.example.root.kotlin_eyepetizer.ui.activity.more_activity
...
import com.example.root.kotlin_eyepetizer.ui.fragment.more_fragment.BookMessageFragment
import com.example.root.kotlin_eyepetizer.ui.fragment.more_fragment.MovieMessageFragment
import com.example.root.kotlin_eyepetizer.ui.fragment.more_fragment.PickOverMessageFragment
...
class MoreFunctionActivity : AppCompatActivity() {
   ...
   private val pickOverMessageFragment by lazy { PickOverMessageFragment() }
   private val movieMessageFragment by lazy { MovieMessageFragment() }
   private val bookMessageFragment by lazy { BookMessageFragment() }
   ...
   private var navigationListener = BottomNavigationView.OnNavigationItemSelectedListener {
      ...
      when (it.itemId) {
         R.id.menu_item_pick_over ->  {
            transaction.show(pickOverMessageFragment)
